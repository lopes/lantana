...
**Day two morning** — first full pipeline cycle. By ~06:00 UTC the entire chain (prune → enrich → transform → report) has run. Run `validate-pipeline-cycle.yml` to confirm everything fired cleanly:
