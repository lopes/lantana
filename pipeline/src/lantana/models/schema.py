...
NOTE: as of 2026-05-26 these dicts have no callers — bronze ingestion
reads NDJSON without explicit schemas, letting Polars infer types from
the data. They are kept here as a future-validation hook (e.g. to assert
a bronze partition matches one of these shapes before promoting to
silver). Delete if that use case never materialises.
"""
